                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">Session Title: </label><br><br>
                                </td>
                                <td class="label-td" colspan="2">
                                    '.$title.'<br><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Doctor of this session: </label><br><br>
                                </td>
                                <td class="label-td" colspan="2">
                                '.$docname.'<br><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nic" class="form-label">Scheduled Date: </label><br><br>
                                </td>
                                <td class="label-td" colspan="2">
                                '.$scheduledate.'<br><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Tele" class="form-label">Scheduled Time: </label><br><br>
                                </td>
                                <td class="label-td" colspan="2">
                                '.$scheduletime.'<br><br>
                                </td>
