                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">Patient ID: </label><br><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nic" class="form-label">NIC: </label><br><br>
                                </td>
                                <td class="label-td" colspan="2">
                                '.$nic.'<br><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Tele" class="form-label">Telephone: </label><br><br>
                                </td>
                                <td class="label-td" colspan="2">
                                '.$tele.'<br><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Address: </label><br><br>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">Date of Birth: </label><br><br>
                                </td>
                                <td class="label-td" colspan="2">
                                    '.$dob.'<br><br>
                                </td>
