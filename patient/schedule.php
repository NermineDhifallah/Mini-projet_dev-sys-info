                            ...
                            <?php
                                ...
                                for ( $x=0; $x<($result->num_rows);$x++){
                                    ...
                                    for($q=0;$q<3;$q++){
                                       ...
                                       // $calc= $database->query("select count(*) AS appointment_count from appointement scheduleid=$scheduleid;") ;

                                        $query = "SELECT COUNT(*) AS appointment_count FROM appointment WHERE scheduleid = $scheduleid;";
                                        $calc = $database->query($query);
                                        $calfetch=$calc->fetch_assoc();
                                        $shid= $calfetch["appointment_count"];
                                        $res=$max <= $shid;
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <br>
                                                            <a' . $disabled . ' href="booking.php?id='.$scheduleid.'" ><button ' . $disabled . 'class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%" ><font class="tn-in-text">Book Now</font></button></a>
                                                    </div>
